...
| Cost of `make check-static` | 2616 ms from a clean tree; 138 ms and 140 ms with the build already done | 2026-08-27 | 3 runs, all three values listed. Nine cases, four of them C binaries built with the sanitizers |
